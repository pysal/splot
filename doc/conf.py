# -*- coding: utf-8 -*-
#
# splot documentation build configuration file, created by
...
#
# The full version.
version = splot.__version__ #should replace it with your PACKAGE_NAME
release = splot.__version__ #should replace it with your PACKAGE_NAME
...
html_theme_options = {
    ...
    'navbar_title': "splot", # string of your project name, for example, 'giddy'
...
latex_documents = [
    (master_doc, 'splot.tex', u'splot Documentation',
...
man_pages = [
    (master_doc, 'splot', u'splot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'splot', u'splot Documentation',
     author, 'splot', 'One line description of project.',
     'Miscellaneous'),
]
